...
struct VoiceInkApp: App {
    ...
    init() {
        ...
        FreshInstallDefaults.seedAtLaunch()
...
class UpdaterViewModel: ObservableObject {
    ...
    init() {
        // LOCAL_BUILD: never start Sparkle. Auto-updating would replace this
        // build with the official release, which then demands a license
        // (upstream issue #829).
        #if LOCAL_BUILD
