...
enum PromptTemplates {
    ...
    static let codingPromptId = UUID(uuidString: "00000000-0000-0000-0000-000000000006")!
    static let textingPromptId = UUID(uuidString: "00000000-0000-0000-0000-000000000007")!
    ...
    static func createTemplatePrompts() -> [TemplatePrompt] {
        [
            ...
            TemplatePrompt(
                ...
                promptText: """
                    Format the dictated speech in <TRANSCRIPT> as instructions to an AI coding agent.

                    # Rules
                    - Preserve technical terms, file paths, function names, flags, and shell commands exactly as spoken; never rewrite them into prose.
                    - Convert spoken symbols into symbols: "dash dash force" becomes --force, "dot env" becomes .env, "at main" becomes @main.
                    - Keep identifiers in their spoken casing and joined form: "use effect" in a React context becomes useEffect.
                    - Keep the imperative, direct phrasing. Do not add greetings, pleasantries, or hedging.
                    - Keep dictated steps as a list when the speaker enumerates them.
                    - Do not wrap the result in quotes or code fences unless dictated.
                    """,
                useSystemInstructions: true
            ),
            TemplatePrompt(
                ...
                title: "Texting",
                promptText: """
                    Format the dictated speech in <TRANSCRIPT> as a casual text message.

                    # Rules
                    - Keep the speaker's tone, slang, and phrasing. Do not formalize or expand contractions.
                    - Keep it brief. No greetings or sign-offs unless dictated.
                    - Light punctuation only; a casual style is fine when it matches the speaker's voice.
                    - Never add emojis unless the speaker dictated one.
                    """,
                useSystemInstructions: true
            ),
        ]
