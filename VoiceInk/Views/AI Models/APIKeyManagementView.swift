            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                if aiService.selectedProvider == .ollama {
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        Text("Runs a command-line AI tool on your Mac. If you use Claude Code, pick the Claude template: enhancement runs on your existing Claude subscription, no API key needed.")
                            .font(.subheadline)
                            .foregroundColor(.secondary)
