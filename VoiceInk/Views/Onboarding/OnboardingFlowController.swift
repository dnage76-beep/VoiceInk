...
final class OnboardingFlowController {
    ...
    func completeOnboarding(
        ...
        #if LOCAL_BUILD
            // Local builds finish onboarding from the trust screen (no license step).
            let canCompleteFromStage = coordinator.stage == .license || coordinator.stage == .trust
        #else
            let canCompleteFromStage = coordinator.stage == .license
        #endif
        guard
            canCompleteFromStage
