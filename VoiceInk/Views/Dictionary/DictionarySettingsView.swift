...
struct DictionarySettingsView: View {
    ...
    private let dictionaryInfoMessage: LocalizedStringKey =
        "Snippets swap a spoken phrase for saved text: say \"my work email\" and the address lands instead. Vocabulary teaches the AI your names, jargon, and spellings so they come out right."

    enum DictionarySection: String, CaseIterable, Hashable {
        case replacements = "Snippets"
        ...
        var description: String {
            ...
            case .replacements:
                return String(
                    localized:
                        "The stuff you should not have to re-type. Say the phrase, get the saved text: emails, links, boilerplate, fixes for words the model keeps missing."
                )
            }
        }
