    ...
    static let templates: [TriggerTemplate] = [
        TriggerTemplate(
            ...
            apps: [
                ...
                .init(bundleIdentifier: "com.github.wez.wezterm", names: ["WezTerm"]),
                .init(bundleIdentifier: "io.alacritty", names: ["Alacritty"]),
                ...
                .init(bundleIdentifier: "dev.zed.Zed", names: ["Zed"]),
                .init(bundleIdentifier: "com.apple.dt.Xcode", names: ["Xcode"]),
                .init(bundleIdentifier: "com.anthropic.claudefordesktop", names: ["Claude"]),
            ],
            websites: [
                "github.com", "claude.ai/code"
            ]
        ),
        TriggerTemplate(
            id: "ai",
