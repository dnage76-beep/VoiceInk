...
class WindowManager: NSObject {
    ...
    func configureWindow(_ window: NSWindow) {
        ...
        // Empty transparent toolbar: makes macOS lay out the traffic lights with
        // the modern unified-toolbar inset instead of the cramped legacy titlebar
        // position, so the window chrome reads native.
        if window.toolbar == nil {
            let toolbar = NSToolbar(identifier: "MainWindowChromeToolbar")
